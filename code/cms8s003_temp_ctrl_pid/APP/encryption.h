...
#define DEBUG_MCUID											0				//打印MCUID
#define MCU_UUID_ADDR										0xF5E0	//MCU的UUID起始地址
#define CPUID_LENGTH										12			//CPUID 长度
#define ID_WRITE_ADDR										HAL_FLASH_ENCRYPTION_SAVE_ADDR//加密后的ID写入到指定位置 如果地址为0则按照编译器分配的地址写入ID (ID长度12个字节)
